...
//		arrayCopySystem();
	...
	private static void usingArray () {
		...
		//	참조 복제 -> 객체의 주소를 복사하는 것 (같은 객체를 가리키고 있는 것) 
	...
	private static void multiDimArrayEx() {
		...
		System.out.println("tabel.length: " + table.length);
...
//		일반적인 for문 
		...
		System.out.println();
		//	Enhanced For;
		//	카운터 변수, 반복 조건, 증감식 신경 쓰지 않고 
		// 	손쉽게 컬렉션 데이터(배열 등)를 조작할 수 있음 
		for (int num: nums) {
